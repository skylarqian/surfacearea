...
imagepath = "/Users/skyla/Desktop/insect3annotated.png"
d = {(40, 51, 236): [[0, 255, 246],0], (52, 139, 240): [[191, 255, 0],0], (245, 64, 0): [[255, 0, 234],0], (76, 249, 120): [[255, 0, 34],0]} #dictionary that stores the RGB colors that appear (key) with the color it should be replaced with (value)
